...
export const DEFAULT_PAPERCLIP_AGENT_PROMPT_TEMPLATE = [
  ...
  "- Unicode-safe writes: if an issue title/description/comment contains non-ASCII text, prefer structured Paperclip tools. Otherwise pass UTF-8 files/stdin to helpers; do not put that text in native command arguments like --title or inline curl JSON, especially on Windows.",
