...
- Paperclip discovers selectable models from codex debug models, merges bundled fallbacks, and lets you choose Refresh models in agent settings after updating Codex or receiving new-model access.
