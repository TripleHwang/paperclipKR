...
export function MobileBottomNav({ visible }: MobileBottomNavProps) {
  ...
  const items = useMemo<MobileNavItem[]>(
    () => [
      { type: "link", to: "/dashboard", label: t("app.sidebar.mobile.home"), icon: House },
      { type: "link", to: "/issues", label: t("app.sidebar.mobile.issues"), icon: CircleDot },
      { type: "action", label: t("app.sidebar.mobile.create"), icon: SquarePen, onClick: () => openNewIssue() },
      { type: "link", to: "/agents/all", label: t("app.sidebar.mobile.agents"), icon: Users },
      {
        type: "link",
        to: "/inbox",
        label: t("app.sidebar.mobile.inbox"),
        icon: Inbox,
  ...
  return (
    <nav
      ...
      aria-label={t("app.sidebar.mobile.navigation")}
    >
